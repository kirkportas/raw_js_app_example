...
this["JST"]["www/templates/landing.hbs"] = Handlebars.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "        <ul>\r\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.example_tasks : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "        </ul>\r\n        <span id=\"task_count\"> "
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? depth0.example_tasks : depth0)) != null ? stack1.length : stack1), depth0))
    + " items in list </span>\r\n";
  ...
  return "<div class=\"col-md-4 col-md-offset-4\">\r\n    <div class=\"header\">\r\n        <h1 class=\"\">Task App</h1>\r\n    </div>\r\n"
    ...
    + "    <div id=\"task-list\">\r\n"
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.example_tasks : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
    + "    </div>\r\n    <!--  -->\r\n\r\n    <!-- Footer -->\r\n</div>\r\n";
